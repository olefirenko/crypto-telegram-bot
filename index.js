...
bot.on("message", (msg) => {
  ...
  switch (msg.text) {
    case "/start":
      bot.sendMessage(
        chatId,
        "Hi there! I am 🤖 Alice Crypto Bot.To get the price of any token just send me the message <i>/price <TOKEN></i>. For example to get the price of <b>BTC</b>: <i>/price BTC</i>",
        { parse_mode: "HTML" }
      );
      break;
